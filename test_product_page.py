...
#Добавим немного параметризации нашему тесту. Задача - передать список ссылок, которые надо проверить на падения
...
def test_guest_should_see_login_link(browser, link): #заходим на страницу, тыкаем в кнопку "добавить в корзину"
    #link = "http://selenium1py.pythonanywhere.com/catalogue/the-shellcoders-handbook_209/?promo=newYear"
    #link = "http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/"
